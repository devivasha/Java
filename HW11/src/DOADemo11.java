...
public class DOADemo11 {
    public static void main(String[] args) throws ParseException {
        ...
        Woman11 woman9 = new Woman11("Elene", "Karleone", "23/01/1999",50, new HashMap<String, String>(), dog8);
        Man11 man9 = new Man11("Michael", "Karleone", "23/01/1998",80, new HashMap<String, String>(), dog8);
        Family11 family9 = null;
        if (familyController11.createNewFamily(woman9, man9)) {
            family9 = familyController11.getFamilyById(familyController11.count() - 1);
        }
        if (family9 != null) {
            familyController11.bornChild(family9, "Michael", "Elene");
        }
        familyController11.createNewFamily(new Woman11("Olga", "GGGGG", "23/12/1999",50, new HashMap<String, String>(), dog8), new Man11("Bob", "GGGGG", "23/01/1999",80, new HashMap<String, String>(), dog8));
        familyController11.createNewFamily(new Woman11("Nana", "BBBBB", "23/10/1999",50, new HashMap<String, String>(), dog8), new Man11("Bil", "BBBBB","23/03/1999",80, new HashMap<String, String>(), dog8));
        ...
        Human11 child = new Man11("Richard", "GGGGG", "12/05/1999",50, new HashMap<String, String>(), dog8);
        if (familyController11.adoptChild(family9, child)) {
