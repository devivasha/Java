...
public abstract class Pet9 {
    ...
    public Pet9(String nickname){
        this.nickname = nickname;
    }

    public Pet9(String nickname, int age, int trickLevel, Set<String> habits) {
        this.nickname = nickname;
        this.age = age;
        this.trickLevel = trickLevel;
        this.habits = habits;
    ...
    public void setFamily(Family9 family9) {
